...
namespace ToxWinApp
{
    ...
    public sealed partial class ConversationPage : Page
    {
        ...
        {
            this.Conversation = (Conversation)e.NavigationParameter;
            this.conversationListView.ItemsSource = this.Conversation;
            this.conversationTitle.Text = this.Conversation.Title;
        }
